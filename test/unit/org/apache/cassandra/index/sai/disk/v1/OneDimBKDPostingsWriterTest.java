...
public class OneDimBKDPostingsWriterTest extends NdiRandomizedTest
{
    ...
    public void shouldWritePostingsForEligibleNodes() throws IOException
    {
        ...
        OneDimBKDPostingsWriter writer = new OneDimBKDPostingsWriter(leaves, new IndexWriterConfig("test", 2, 1), newVersionedIndex());
    ...
    public void shouldSkipPostingListWhenSamplingMisses() throws IOException
    {
        ...
        OneDimBKDPostingsWriter writer = new OneDimBKDPostingsWriter(leaves, new IndexWriterConfig("test", 5, 1), newVersionedIndex());
    ...
    {
        List<PackedLongValues> leaves = Collections.singletonList(postings(1, 2, 3));
        OneDimBKDPostingsWriter writer = new OneDimBKDPostingsWriter(leaves, new IndexWriterConfig("test", 2, 2), newVersionedIndex());
