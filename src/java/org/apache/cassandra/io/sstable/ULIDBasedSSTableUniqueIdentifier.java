...
import net.openhft.chronicle.core.util.ThreadLocalSecureRandom;
import org.apache.cassandra.utils.ByteBufferUtil;

public class ULIDBasedSSTableUniqueIdentifier implements SSTableUniqueIdentifier
{
    ...
    public static class Builder implements SSTableUniqueIdentifier.Builder<ULIDBasedSSTableUniqueIdentifier>
    {
        ...
        {
            ULID ulid = new ULID(new Random(new SecureRandom().nextLong()));
            return () -> new ULIDBasedSSTableUniqueIdentifier(ulid.nextValue());
        }

        @Override
        public ULIDBasedSSTableUniqueIdentifier fromString(@Nonnull String s)
        {
            return new ULIDBasedSSTableUniqueIdentifier(ULID.parseULID(s));
        }

        @Override
        public ULIDBasedSSTableUniqueIdentifier fromBytes(@Nonnull ByteBuffer byteBuffer)
        {
