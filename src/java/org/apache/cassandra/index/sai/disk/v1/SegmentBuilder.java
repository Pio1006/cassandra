...
public abstract class SegmentBuilder
{
    ...
    public static class KDTreeSegmentBuilder extends SegmentBuilder
    {
        ...
        @Override
        protected SegmentMetadata.ComponentMetadataMap flushInternal(IndexDescriptor indexDescriptor, ColumnContext columnContext) throws IOException
        {
    ...
    public SegmentMetadata flush(IndexDescriptor indexDescriptor, ColumnContext columnContext) throws IOException
    {
        assert !flushed;
        flushed = true;
     ...
     */
    public long release(ColumnContext columnContext)
    {
        if (active)
        {
    ...
    protected abstract SegmentMetadata.ComponentMetadataMap flushInternal(IndexDescriptor indexDescriptor, ColumnContext columnContext) throws IOException;
