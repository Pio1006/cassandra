...
public interface SegmentMerger extends Closeable
{
    ...
    SegmentMetadata merge(IndexDescriptor indexDescriptor, ColumnContext context, DecoratedKey minKey, DecoratedKey maxKey, long maxSSTableRowId) throws IOException;
    ...
    class LiteralSegmentMerger implements SegmentMerger
    {
        ...
        @Override
        public SegmentMetadata merge(IndexDescriptor indexDescriptor, ColumnContext context, DecoratedKey minKey, DecoratedKey maxKey, long maxSSTableRowId) throws IOException
        {
